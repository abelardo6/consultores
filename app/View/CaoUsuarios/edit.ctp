...
echo $this->Form->create($model, array(
	...
	'error' => array('attributes' => array('wrap' => 'span', 'class' => 'error-message')),
		...
		<div class="modal-header">
			...
			<h4 class="blue bigger">Editar Impuesto</h4>
		</div>
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12">
					<div class="form-group">
						<?php
						 echo $this->Form->input('id', array('id' => 'idEdit'));
		...
		$(function() {
			EditarFormulario('content_modal', '<?php echo $url; ?>', $('#idEdit').val(), '<?php echo $this->name; ?>');
  		});
		</script>
